...
urlpatterns = [
    ...
    path('search=<int:type>&inoutstate=<int:inorout>&state=<str:state>&tuition=<int:tuition>&enrollment=<int:size>&degree=<int:degree>&gender=<int:gender>', views.getSchools, name = 'allSchools')
] 
